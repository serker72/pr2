...
unset($smarty);
	...
	$filetext2=$as->ShowData($pdate2_1,$pdate2_2,  $result['org_id'],$decorator,'goods_on_as/goods_on_as'.$print_add.'.html','goods_on_stor.php',$au->user_rights->CheckAccess('w',288),$_alls, isset($_GET['doSub2'])||isset($_GET['doSub2_x'])||(isset($_GET['print'])&&($_GET['print']>0)&&isset($_GET['tab_page'])&&($_GET['tab_page']==2)),$only_period_2);
