...
$smarty->assign("SITETITLE",'Сравнение опций программы и МТО');
    ...
    <?
		if(isset($_FILES['file'])){
			...
			/* echo '<pre>';
			 ...
			 ?>
             <h2>Станок <?=$eq['name']?></h2>
                  <h3>Опции, которые есть в МТО, и которых нет в программе:</h3>
           
             <table width="*" border="1" cellpadding="2" cellspacing="0"?
             <thead>
             <tr align="left" valign="top">
             	<th width="100">Код по пр-ме</th>
                <th width="100">Код Интермак</th>
                <th width="100">Цена, &euro;</th>
                <th width="*">Англ. название</th>
             </tr>
             </thead>
             <tbody>
             <?
          ...
          <!--   
                  ...
                  <h3>Опции c изменяемыми названиями:</h3>
             <table width="*" border="1" cellpadding="2" cellspacing="0"?
             <thead>
             <tr align="left" valign="top">
             	<th width="100">Код по пр-ме</th>
                <th width="100">Код Интермак</th>
                <th width="100">Цена, &euro;</th>
                <th width="*">Название англ.</th>
                <th width="*">Название (старое)</th>
...
<br />
           ...
           <h3>Опции, которые есть в программе, и которых нет в МТО:</h3>
             <table width="*" border="1" cellpadding="2" cellspacing="0"?
             <thead>
             <tr align="left" valign="top">
           <th width="100">Код по пр-ме</th>
             ...
             ?>
              ...
              <h3>Опции есть в МТО и в программе, будут изменены в программе на:</h3>
             <table width="*" border="1" cellpadding="2" cellspacing="0"?
             <thead>
             <tr align="left" valign="top">
             <th width="100">Код по пр-ме</th>
                ...
                <th width="100">Код (в пр-ме)</th>
                  <th width="100">Код (в пр-ме)</th>
                <th width="100">Цена, &euro; (в пр-ме)</th>
                <th width="*">Опция (в пр-ме)</th>
             </tr>
             </thead>
             <tbody>
             <?
