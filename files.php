...
//раздел ФАЙЛЫ и Документы
	...
	$ffg->SetPageName('files.php');
	  ...
	  //if($au->user_rights->CheckAccess('w',840)) 
		...
		'files.php', //5
		'load.html', //6
		'swfupl-js/files.php', //7
		$au->user_rights->CheckAccess('w',30), //8
		$au->user_rights->CheckAccess('w',32), //9
		$au->user_rights->CheckAccess('w',60),	//10
		$folder_id_own,  //11
		$au->user_rights->CheckAccess('w',572), //12
		$au->user_rights->CheckAccess('w',573), //13
		$au->user_rights->CheckAccess('w',574), //14
		$au->user_rights->CheckAccess('w',575),	//15
	
	
		'', //16
		$result, //17
		$au->user_rights->CheckAccess('w',802), //18
		$au->user_rights->CheckAccess('w',116), //19
	...
	// else $filetext='<em>Извините, у Вас нет доступа в этот раздел.</em>';
	
	$sm->assign('log',$filetext);
	
	$sm->assign('has_files',  $au->user_rights->CheckAccess('w',840));
...
//************ письма *********************************************************************************************	
	...
	$filetext=$ffg->ShowFiles('files/list.html', $decorator,$from_own,$to_page,'filesl.php', 'load_l.html', 'swfupl-js/filesl.php',  $au->user_rights->CheckAccess('w',557),   $au->user_rights->CheckAccess('w',559),  $au->user_rights->CheckAccess('w',558),$folder_id_own,  $au->user_rights->CheckAccess('w',576), $au->user_rights->CheckAccess('w',577), $au->user_rights->CheckAccess('w',578), $au->user_rights->CheckAccess('w',579) , '4' ,
	 ...
	 $result,
	  $au->user_rights->CheckAccess('w',803),
...
/** файлы +/- ********************************************************************************************************/	
	...
	$filetext=$ffg->ShowFiles('files/list.html', $decorator,$from_own,$to_page,'filespm.php', 'load_pm.html', 'swfupl-js/filespm.php',  $au->user_rights->CheckAccess('w',561),   $au->user_rights->CheckAccess('w',563),  $au->user_rights->CheckAccess('w',562),$folder_id_own,  $au->user_rights->CheckAccess('w',580), $au->user_rights->CheckAccess('w',581), $au->user_rights->CheckAccess('w',582), $au->user_rights->CheckAccess('w',583), '5',
...
// раздел справочная информация (FAQ)	
	...
	$ffg->SetPageName('files.php');
	 ...
	 $filetext=$ffg->ShowFiles( 
		...
		'2', //16
		$result, //17
		$au->user_rights->CheckAccess('w',800), //18
		$au->user_rights->CheckAccess('w',116), //19
		35, 
		2,
		3,
	...
	$sm->assign('has_faq', $au->user_rights->CheckAccess('w',841));
...
//раздел Спецдокументы
	...
	$filetext=$ffg->ShowFiles('files/list.html', $decorator,$from_own,$to_page,'sps.php', 'load_spl.html', 'swfupl-js/sps.php', $au->user_rights->CheckAccess('w',477),  $au->user_rights->CheckAccess('w',479), $au->user_rights->CheckAccess('w',478), $folder_id_own,  $au->user_rights->CheckAccess('w',568), $au->user_rights->CheckAccess('w',569), $au->user_rights->CheckAccess('w',570), $au->user_rights->CheckAccess('w',571), '3',
	 ...
	 $result,
	 $au->user_rights->CheckAccess('w',801),
	 $au->user_rights->CheckAccess('w',116),
