...
<br />
<br />
<strong>С целью улучшения работы программы "Электронное
снабжение" проводятся профилактические работы. <br />
Расчетное время
запуска программы: 0:00 30 июля 2012 г.</strong>
  ...
  <ul>
    <li><a href="#tabs-1">Смена пароля</a>
	 ...
	 <div id="tabs-1">
		 ...
		 <strong>Уважаемый(ая) <?=$result['name_s']?>!</strong>
<br />
<br />
<br />
...
допустимые символы - латинские буквы и цифры</em></small><br />
	...
	<?
	  ...
	  //$ofg=new OrderFileGroup;
	  //$rfg=new ReclamFileGroup;
	  //$cfg=new ClaimFileGroup;
	 ...
	 // print_r($result);
	  ...
	  $usg=new UsersSGroup;
	  /*$content='
	  <h1>Добро пожаловать, '.stripslashes($result['name_s']).'!</h1>';
	  $content.='<br /><br />
  ...
  */
	...
	//  $fmg->ClearLostFiles();
	  ...
	  //получим время работы по выбранному + 4 предыдущих дня
	  ...
	  for($i=0; $i<4; $i++){
		 ...
		 $pdate11=$current_date; $pdate12=$current_date+24*60*60-1;
	  ...
	  $_last_docs->AddDoc( new LastDocs_KP(array(696, 701), NULL, 'ed_kp.php', 'action=1', 'id'));
	  ...
	  //extended data
	  $sm1->assign('can_extended_stat', $au->user_rights->CheckAccess('w',752)||$au->user_rights->CheckAccess('w',1));
