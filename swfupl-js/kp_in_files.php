<?php
	...
	//	move_uploaded_file ( $_FILES['Filedata']['tmp_name'], $tempname);
		...
		$log->PutEntry( $result['id'],'добавил файл вход/исход КП',NULL,1021,NULL,'имя файла '.SecStr(iconv("utf-8","windows-1251", $_FILES['Filedata']['name'])), $id);
