<?php
	...
	//	move_uploaded_file ( $_FILES['Filedata']['tmp_name'], $tempname);
		...
		$log->PutEntry( $result['id'],'добавил файл заявки на договор',NULL,1151,NULL,'имя файла '.SecStr(iconv("utf-8","windows-1251", $_FILES['Filedata']['name'])), $id);
