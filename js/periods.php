...
if(isset($_POST['action'])&&($_POST['action']=="change_year")){
	...
	$ret=$_pg->DrawPeriods($result['org_id'],$year,'periods/periods.html',$au->user_rights->CheckAccess('w',467),$au->user_rights->CheckAccess('w',468),  $result['org_id'], true, true);
}
elseif(isset($_POST['action'])&&($_POST['action']=="redraw_is_confirmer")){
	...
	$ret=$_pg->DrawPeriods($result['org_id'],date('Y', $params['pdate_beg']),'periods/periods.html', $au->user_rights->CheckAccess('w',467),$au->user_rights->CheckAccess('w',468),  $result['org_id'], true, false,$the_only_number);
}
