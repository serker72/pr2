...
if(isset($_POST['action'])&&($_POST['action']=="as_by_pos_prihod")){
	...
	$ret=$_kr->InAccByPos($position_id, $pl_position_id, $pdate1,$pdate2,'goods_on_stor/in_accs_in.html',$result['org_id'],true,$sector_id,$storage_id,$limited_sector,$_extended_limited_sector);
	...
	$ret.=$_kr->InWfByPos($position_id, $pl_position_id, $pdate1,$pdate2,'goods_on_stor/in_accs.html',$result['org_id'],true,$sector_id,$storage_id,$limited_sector,$_extended_limited_sector);
