...
function GetMessageText($user){
	...
	$text.='Ваш доступ к программе CRM GYDEX."'.SITETITLE.'" <a href="http://www.gydex.ru">http://www.gydex.ru</a>:';
	...
	$text.='С уважением, программа  CRM GYDEX."'.SITETITLE.'".';
...
if(isset($_POST['action'])&&($_POST['action']=="do_chp")){
	...
	$log->PutEntry($result['id'], 'сбросил пароль сотруднику', $id, 852, NULL, '', $id);
