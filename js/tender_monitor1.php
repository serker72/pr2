...
require_once('../classes/tender_monitor_view1.class.php');
require_once('../classes/tender_monitor_view2.class.php');
...
if(isset($_POST['action'])&&(($_POST['action']=="mode_reestr"))){
	$_views=new  TenderMonitor_View1Group;
	$_view=new  TenderMonitor_View1Item;
