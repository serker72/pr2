...
elseif(isset($_POST['action'])&&($_POST['action']=="toggle_confirm")){
	...
	*/
	...
	if($shorter==0) $ret=$acg->ShowAllPos($template, $dec, $au->user_rights->CheckAccess('w',272)||$au->user_rights->CheckAccess('w',281), $au->user_rights->CheckAccess('w',279) ,0,100, $au->user_rights->CheckAccess('w',277),  $au->user_rights->CheckAccess('w',96),false,true,$au->user_rights->CheckAccess('w',280),$au->user_rights->CheckAccess('w',278));
	else $ret=$acg->ShowAllPos($template, $dec, $au->user_rights->CheckAccess('w',272)||$au->user_rights->CheckAccess('w',281), $au->user_rights->CheckAccess('w',279),0,100,$au->user_rights->CheckAccess('w',277),  $au->user_rights->CheckAccess('w',96),false,true, $au->user_rights->CheckAccess('w',280),$au->user_rights->CheckAccess('w',278));
	 ...
	 // $acg=new PayGroup;
	  ...
	  if($shorter==0) $ret=$acg->ShowAllPos($template, $dec, $au->user_rights->CheckAccess('w',272)||$au->user_rights->CheckAccess('w',281), $au->user_rights->CheckAccess('w',279),0,100,$au->user_rights->CheckAccess('w',277),  $au->user_rights->CheckAccess('w',96),false,true,$au->user_rights->CheckAccess('w',280), $au->user_rights->CheckAccess('w',278));
		 ...
		 // echo 'zzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzzz';
		  ...
		  $ret=$acg->ShowPos($bill_id, $trust['supplier_id'], $template, $dec2, $au->user_rights->CheckAccess('w',272)||$au->user_rights->CheckAccess('w',281), $au->user_rights->CheckAccess('w',279),$au->user_rights->CheckAccess('w',277),  $au->user_rights->CheckAccess('w',96),false,true,$au->user_rights->CheckAccess('w',280),$au->user_rights->CheckAccess('w',278));
