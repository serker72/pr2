...
$log=new ActionLog;
$log->PutEntry($result['id'],'скачал файл исход. документа',NULL, 1065, NULL,SecStr('файл '.$fmi['orig_name'].' дл€  ѕ '.  $user['code'].' '.$_folder_desrc),$user['id']);
