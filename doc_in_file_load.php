...
$log=new ActionLog;
$log->PutEntry($result['id'],'скачал файл вход. документа',NULL, 1080, NULL,SecStr('файл '.$fmi['orig_name'].' для КП '.  $user['code'].' '.$_folder_desrc),$user['id']);
