...
$smarty->assign("SITETITLE",'Акты сверки контрагента');
...
$log->PutEntry($result['id'],'открыл реестр файлов актов сверки контрагента',NULL,91, NULL, $user['code'].' '.$user['full_name'].$_folder_desrc,$sup_id);
...
if(isset($_GET['action'])&&($_GET['action']==2)){
	...
	if($file!==false){
		...
		$log->PutEntry($result['id'],'удалил акт сверки',NULL,320,NULL,'имя файла '.SecStr($file['orig_name']),$sup_id);
	}
