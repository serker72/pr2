...
$_fmi=new DocIn_HistoryFileItem;
...
$log=new ActionLog;
$log->PutEntry($result['id'],'скачал файл вх. документа', NULL, 1080, NULL,SecStr('файл '.$fmi['orig_name'].' для тендера '.  $user['code'].' '.$_folder_desrc),$user['id']);
