...
class InvCalcBindedGroup extends AbstractGroup {
	...
	public function ShowBills($invcalc_id, $template, DBDecorator $dec,$from=0,$to_page=ITEMS_PER_PAGE, $can_add=false, $can_edit=false, $can_delete=false, $add_to_bill='', $can_confirm=false,  $can_super_confirm=false, $has_header=true, $is_ajax=false, $can_restore=false,$limited_sector=NULL,$nested_bill_positions=NULL, $can_confirm_ship=false, $can_unconfirm=false, $can_unconfirm_ship=false, $result=NULL, $is_incoming=1){
