...
//  группа прайс-лист для получения позиций в счете
class PlPosGroupForBill extends PlPosGroup {
	...
	public function GainSql(&$sql, &$sql_count){
		$sql='select pl.id as pl_position_id, pl.id as pl_id, pl.position_id, pl.price as price, pl.discount_id as pl_discount_id, pl.discount_value as pl_discount_value, pl.discount_rub_or_percent as pl_discount_rub_or_percent,  
					dis.name,
					p.dimension_id,
