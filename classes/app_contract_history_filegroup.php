...
// группа файлов ленты лида
class AppContractHistoryFileGroup extends AbstractFileGroup {
	...
	protected function init($id){
		$this->tablename='app_contract_history_file';
		$this->item=NULL;
		...
		$this->storage_path=ABSPATH.'upload/files/app_contract_history/';	
	}
