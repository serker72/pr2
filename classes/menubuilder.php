			...
			if($v->parent_id==$parent_id){
				 ...
				 if($point['item']!==NULL){
					...
					foreach($point['subs'] as $pp){
						...
						//для тендеров: принять раскрытие род. блока, если в подблоке новых тендеров >0
						//if($pp['item']['parent_active']) $was=$was||true;
					}
