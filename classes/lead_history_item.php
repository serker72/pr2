...
//запись ленты лида
class Lead_HistoryItem extends AbstractItem{
	...
	public function Add($params){
		 ...
		 if(($ti['status_id']==2)&&($ti['manager_id']==$params['user_id'])){
				...
				$log->PutEntry($params['user_id'], 'смена статуса лида',NULL,950,NULL,'установлен статус '.$status['name'].' при внесении комментария ответственным сотрудником '.$user['name_s'],$params['sched_id']);
