...
// группа файлов ленты исх док-та
class DocOut_HistoryFileGroup extends AbstractFileGroup {
	...
	protected function init($id){
		$this->tablename='doc_out_history_file';
		$this->item=NULL;
		...
		$this->storage_path=ABSPATH.'upload/files/doc_out_history/';	
	}
