...
class AppContractGroup extends AbstractGroup {
    ...
    // Показать договора
    public function ShowPos($template, DBDecorator $dec, $from=0, $to_page=ITEMS_PER_PAGE, $dealer_id=0, $can_create_contract, $can_edit_contract, $can_delete_contract, $can_view_all=false){
        $sm = new SmartyAdm;
