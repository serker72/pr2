...
class BillInGroup extends AbstractBillGroup {
	...
	public function AutoEq($days=30, $days_no_acc=45){
		...
		$sql='select * from bill where is_incoming="'.$this->is_incoming.'" and  status_id in(2,9) and is_confirmed_price=1 and is_confirmed_shipping=1 and cannot_eq=0 order by id desc';
