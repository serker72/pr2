...
// группа файлов ленты вн док-та
class DocVn_HistoryFileGroup extends AbstractFileGroup {
	...
	protected function init($id){
		$this->tablename='doc_vn_history_file';
		$this->item=NULL;
		...
		$this->storage_path=ABSPATH.'upload/files/doc_vn_history/';	
	}
