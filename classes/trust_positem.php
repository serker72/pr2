...
class TrustPosItem extends AbstractItem{
	...
	public function GetOtherPosArr($position_id, $pl_position_id, $bill_id, $trust_id){
		$arr=array();	
		
		
		$set=new MysqlSet('select t.*, b.code as bill_code from 
		  '.$this->tablename.' as t 
		  ...
		  where 
			...
			and t.pl_position_id="'.$pl_position_id.'" 
