...
// группа файлов ленты вх док-та
class DocIn_HistoryFileGroup extends AbstractFileGroup {
	...
	protected function init($id){
		$this->tablename='doc_in_history_file';
		$this->item=NULL;
		...
		$this->storage_path=ABSPATH.'upload/files/doc_in_history/';	
	}
