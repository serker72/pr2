...
// группа файлов ленты тендера
class Tender_HistoryFileGroup extends AbstractFileGroup {
	...
	protected function init($id){
		$this->tablename='tender_history_file';
		$this->item=NULL;
		...
		$this->storage_path=ABSPATH.'upload/files/tender_history/';	
	}
