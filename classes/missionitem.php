...
require_once('missionfileitem.php');


require_once('authuser.php');
require_once('actionlog.php');
require_once('missionhistoryitem.php');

//абстрактный элемент
class MissionItem extends AbstractItem{
	...
	public function Del($id){
		//удалить все файлы
		$fset=new MysqlSet('select * from mission_file where history_id in (select id from mission_history where mission_id="'.$id.'")');
		...
		//удалить файлы из бд
		$query = 'delete from mission_file where history_id in (select id from mission_history where mission_id="'.$id.'")';
		$it=new nonSet($query);
		
		//удалить историю
		$query = 'delete from mission_history where task_id="'.$id.'";';
		$it=new nonSet($query);
