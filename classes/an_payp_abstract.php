...
class AnPayUnivAbstract{
	...
	public function ShowData($supplier_name, $org_id, $pdate1, $pdate2, $only_vyp, $only_not_vyp, $only_not_payed, $only_payed=false, $show_payed_report=false,  $template, DBDecorator $dec,$pagename='files.php',  $do_it=false, $can_print=false, $dec_sep=DEC_SEP,&$alls, $can_confirm_in_buh=false, $can_unconfirm_in_buh=false){
