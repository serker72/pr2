...
class AbstractGroup {
	...
	//получить запрос для нахождения номера страницы - наследуем, заменяем
	/*protected function GenPageSql( DBDecorator $dec){
	...
	//ПОЛУЧИТЬ НОМЕР СТРАНИЦЫ В РЕЕСТРЕ
	public function CalcPageNo($id,DBDecorator $dec, $to_page=ITEMS_PER_PAGE){
		$sql=$this->GenPageSql($dec);
