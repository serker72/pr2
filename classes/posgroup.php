...
class PosGroup extends AbstractGroup {
	...
	public function ShowPos($template, DBDecorator $dec,$from=0,$to_page=ITEMS_PER_PAGE,$can_edit=false, $can_delete=false, $is_ajax=false, $can_expand_groups=false,$can_add_group=false, $can_edit_group=false, $can_delete_group=false, $can_add=false, $initial_kol='', $prefix='',  $can_max_val=false,  $can_active_position=false, $can_admin_group=false){
		...
		$sm->assign('can_admin_group',$can_admin_group);
