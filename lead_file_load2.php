...
if($fmi['folder_id']==0){
	...
	$_ff=new FileDocFolderItem(2, $fmi['bill_id'], new LeadFileItem2(2));
...
$log=new ActionLog;
$log->PutEntry($result['id'],'скачал файл лида',NULL, 950, NULL,SecStr('файл '.$fmi['orig_name'].' для лида '.  $user['id'].' '.$_folder_desrc),$user['id']);
