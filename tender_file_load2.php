...
if($fmi['folder_id']==0){
	...
	$_ff=new FileDocFolderItem(2, $fmi['bill_id'], new tenderFileItem2(2));
...
$log=new ActionLog;
$log->PutEntry($result['id'],'скачал файл тендера',NULL, 931, NULL,SecStr('файл '.$fmi['orig_name'].' для тендера '.  $user['id'].' '.$_folder_desrc),$user['id']);
