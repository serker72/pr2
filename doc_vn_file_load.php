...
$log=new ActionLog;
$log->PutEntry($result['id'],'скачал файл внутр. документа',NULL, 1091, NULL,SecStr('файл '.$fmi['orig_name'].' дл€  ѕ '.  $user['code'].' '.$_folder_desrc),$user['id']);
