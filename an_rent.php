...
$_menu_id=56;
	...
	$as=new AnRent;
	//$filetext=$as->ShowData(DateFromdmY($pdate1), DateFromdmY($pdate2), $extended_an, $by_org, $template,$decorator,'an_rent.php', isset($_GET['doSub'])||isset($_GET['doSub_x'])||($print==1),$au->user_rights->CheckAccess('w',720), DEC_SEP );
