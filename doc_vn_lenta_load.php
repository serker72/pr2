...
$_fmi=new DocVn_HistoryFileItem;
...
$log=new ActionLog;
$log->PutEntry($result['id'],'скачал файл вн. документа', NULL, 1091, NULL,SecStr('файл '.$fmi['orig_name'].' для тендера '.  $user['code'].' '.$_folder_desrc),$user['id']);
