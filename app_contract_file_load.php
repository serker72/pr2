...
if($fmi['folder_id']==0){
	...
	$_ff=new FileDocFolderItem(1, $fmi['bill_id'], new AppContractFileItem(1));
...
$log=new ActionLog;
$log->PutEntry($result['id'],'скачал файл заявки на договор',NULL, 1150, NULL,SecStr('файл '.$fmi['orig_name'].' для заявки на договор '.  $user['code'].' '.$_folder_desrc),$user['id']);
