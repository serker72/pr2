...
if($print!=0){
	if(!$au->user_rights->CheckAccess('w',370)&&!$au->user_rights->CheckAccess('w',373)&&!$au->user_rights->CheckAccess('w',375)&&!$au->user_rights->CheckAccess('w',483)){
	  header("HTTP/1.1 403 Forbidden");
	  header("Status: 403 Forbidden");
	  include("403.php");
	  die();	
...
if(!$au->user_rights->CheckAccess('w',369)&&!$au->user_rights->CheckAccess('w',372)&&!$au->user_rights->CheckAccess('w',374)&&!$au->user_rights->CheckAccess('w',482)){
	header("HTTP/1.1 403 Forbidden");
	header("Status: 403 Forbidden");
	include("403.php");
	die();	
