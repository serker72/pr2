...
$log->PutEntry($result['id'],'открыл реестр файлов схемы проезда к контрагенту',NULL,91, NULL, $user['code'].' '.$user['full_name'].$_folder_desrc,$sup_id);
...
$_menu_id=27;
	...
	*/
	...
	$ffg=new Supplier_Sh_Group(3, $sup_id,  new FileDocFolderItem(3,  $sup_id, new Supplier_Sh_Item(1)));
