...
$_fmi=new DocOut_HistoryFileItem;
...
$log=new ActionLog;
$log->PutEntry($result['id'],'скачал файл исх. документа', NULL, 1065, NULL,SecStr('файл '.$fmi['orig_name'].' для тендера '.  $user['code'].' '.$_folder_desrc),$user['id']);
