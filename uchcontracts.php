...
$log->PutEntry($result['id'],'открыл реестр учредительных документов контрагента',NULL,91, NULL, $user['code'].' '.$user['full_name'].$_folder_desrc,$sup_id);	
...
$_menu_id=27;
	...
	*/
	...
	'',
	 $au->user_rights->CheckAccess('w',798),
	 $result
